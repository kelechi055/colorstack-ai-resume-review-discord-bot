            ...
            for attachment in message.attachments:
                if attachment.filename.lower().endswith('.pdf'):
                    ...
                    try:
                        ...
                        gif_url = "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExbWNucTZ3b2w3dmtrZ29kcTR0Ym1ieGg2eWs2eDhvYTl3aTgzdG81MiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/MbRdUROzrpoPhEIkMq/giphy.gif"  # Example GIF URL
                        # Completion message
